...
- **Comentários de ensaio:** rubrica entre parênteses, itálico, negrito na cor `--muted` (cinza suave no claro e no escuro). Sem card, sem borda. Não usa a cor do acorde nem da letra. Refrão/TAB mantêm as caixas. Continuam papel no auto-scroll, não relógio.
